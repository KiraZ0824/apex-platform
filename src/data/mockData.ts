...
export const mockMyInvitations: InvitationItem[] = [
  ...
  { id: 'm4', title: '东南亚市场电商合规政策解读', type: '行业研究', status: 'pending', statusLabel: '待结算', statusColor: 'orange', points: 180 },
  { id: 'm5', title: '新能源汽车出海专家访谈', type: '专家访谈', status: 'cancelled', statusLabel: '已取消', statusColor: 'red', points: 160 },
...
export const mockInvitations: Invitation[] = [
  ...
  },
  {
    ...
    points: 180,
    tags: ['合规', '电商'],
    description: '解读东南亚各国电商合规政策，为平台跨境业务提供合规指导',
    detail: '深入研究东南亚主要市场（印尼、泰国、越南、马来西亚、菲律宾等）的电商合规政策，包括跨境数据流动、消费者保护、税务合规、电子支付牌照等核心议题，为平台跨境业务拓展提供合规决策支持。',
    startDate: '2026-05-01',
    endDate: '2026-06-30',
    regDeadline: '2026-04-25',
    acceptanceCriteria: '完成覆盖不少于5个东南亚国家的电商合规政策对比分析报告，提供合规风险矩阵和行动建议',
    registeredCount: 9,
  },
  {
    id: 'i13',
    ...
    points: 160,
    tags: ['新能源', '出海'],
    description: '组织新能源汽车出海领域的专家访谈，梳理海外市场进入策略',
    detail: '特邀新能源汽车行业资深专家进行深度访谈，聚焦中国新能源汽车品牌出海的关键议题：目标市场选择、本地化生产策略、充电基础设施合作模式、海外品牌建设与渠道布局。产出系统性出海策略研究报告。',
    startDate: '2026-05-15',
    endDate: '2026-07-15',
    regDeadline: '2026-05-10',
    acceptanceCriteria: '完成不少于6场专家深度访谈，输出新能源汽车出海策略白皮书，包含市场进入路线图和风险评估',
    registeredCount: 14,
  },
];
